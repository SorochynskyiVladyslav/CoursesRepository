...
const Car = sequelize.define('car_model', {
    model_id: {
...
router.post('/createOrder', function(req, res, next){
    Supply.create({model_id: req.body.car_model, amount: req.body.amount, store_id: req.body.store, price: req.body.price})
        .then(inserted => {
...
router.post('/deleteOrder', function (req, res, next) {
    Supply.destroy({where: {supply_id: req.body.supply_id}});
    res.redirect('/');
})
